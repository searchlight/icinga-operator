...
func RegisterDeepCopies(scheme *runtime.Scheme) error {
	return scheme.AddGeneratedDeepCopyFuncs(
		...
		conversion.GeneratedDeepCopyFunc{Fn: DeepCopy_monitoring_IcingaCommand, InType: reflect.TypeOf(&IcingaCommand{})},
...
// DeepCopy_monitoring_IcingaCommand is an autogenerated deepcopy function.
func DeepCopy_monitoring_IcingaCommand(in interface{}, out interface{}, c *conversion.Cloner) error {
	{
		in := in.(*IcingaCommand)
