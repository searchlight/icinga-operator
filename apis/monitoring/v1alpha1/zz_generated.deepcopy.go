...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *PluginVar) DeepCopyInto(out *PluginVar) {
	*out = *in
	return
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new PluginVar.
func (in *PluginVar) DeepCopy() *PluginVar {
	if in == nil {
		return nil
	}
	out := new(PluginVar)
