...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *NodeAlertStatus) DeepCopyInto(out *NodeAlertStatus) {
	*out = *in
	return
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new NodeAlertStatus.
func (in *NodeAlertStatus) DeepCopy() *NodeAlertStatus {
	if in == nil {
		return nil
	}
	out := new(NodeAlertStatus)
	in.DeepCopyInto(out)
	return out
}
