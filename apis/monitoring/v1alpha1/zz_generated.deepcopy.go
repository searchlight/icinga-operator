...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *IcingaCommandVar) DeepCopyInto(out *IcingaCommandVar) {
	*out = *in
	return
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new IcingaCommandVar.
func (in *IcingaCommandVar) DeepCopy() *IcingaCommandVar {
	if in == nil {
		return nil
	}
	out := new(IcingaCommandVar)
	in.DeepCopyInto(out)
	return out
}
