...
url: /products/searchlight/4.0.1/welcome/install/
aliases:
...
$ kubectl apply -f https://raw.githubusercontent.com/appscode/searchlight/4.0.1/hack/deploy/without-rbac.yaml


# Install with RBAC roles
$ kubectl apply -f https://raw.githubusercontent.com/appscode/searchlight/4.0.1/hack/deploy/with-rbac.yaml
```
