...
| `icinga.icinga.tag`      |  Icinga container image tag to run   | `1.5.9-k8s`               |
...
| `icinga.ido.tag`         |  ido container image tag to run      | `9.5-v3-db`               |
...
| `searchlight.tag`        |  Searchlight image tag to run        | `1.5.9`                   |
